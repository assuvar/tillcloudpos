                    ...
                    >
                      <div className="z-10 flex-1 flex flex-col justify-between">
                        <div className="flex justify-between items-start">
                          ...
                          {!unavailable && (
                            <div className="h-8 w-8 rounded-xl bg-sky-50 text-sky-600 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all">
                              <Plus size={16} />
                            </div>
                          )}
                        </div>
        ...
        <aside className="w-[400px] flex flex-col gap-4 shrink-0">
          <div className="bg-white rounded-[32px] shadow-sm border border-slate-100 p-6 flex-1 flex flex-col">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="h-8 w-8 rounded-full bg-[#f0f9ff] flex items-center justify-center text-sky-600 font-black text-xs">
                {totalItems}
              </div>
            </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1 bg-white border border-slate-100 rounded-full p-1 shadow-sm">
                        <button
                          ...
                          className="h-8 w-8 rounded-full flex items-center justify-center hover:bg-slate-50"
                        >
                          <Minus size={14} />
                        </button>
                        ...
                        <button
                          ...
                          className="h-8 w-8 rounded-full flex items-center justify-center bg-[#0c1424] text-white"
                        >
                          <Plus size={14} />
                        </button>
                      </div>
                      <div className="text-right">
                        <span className="text-xs font-bold text-slate-400 block tracking-tighter">
                          Total
                        </span>
            ...
            <div className="mt-6 pt-6 border-t border-slate-100">
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between items-center bg-[#f0f9ff] p-5 rounded-3xl">
                  <div className="flex flex-col">
                    ...
                    <span className="text-3xl font-black text-[#0c1424]">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  onClick={() =>
                    navigate("/checkout", { state: { billItems, billTotal } })
                  }
                  disabled={billItems.length === 0}
