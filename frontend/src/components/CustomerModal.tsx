              ...
              <div className="flex flex-col items-center justify-center h-full animate-in fade-in duration-500">
                <div className="bg-white rounded-[32px] border-2 border-dashed border-slate-100 p-12 text-center w-full relative">
                  ...
                  <div className="bg-white rounded-[28px] border border-slate-100 p-8 shadow-sm text-left max-w-md mx-auto relative overflow-hidden">
                    <h5 className="text-sm font-black text-[#0c1424] uppercase tracking-widest mb-6 border-b border-slate-50 pb-4">
                      Quick Create
                    </h5>
                    <div className="space-y-4 relative z-10">
                      <input
                        ...
                        className="w-full h-14 px-6 rounded-2xl bg-[#f0f7ff] border-none text-sm font-bold placeholder:text-slate-300"
                      />
                      <input
                        type="text"
                        placeholder="Phone"
