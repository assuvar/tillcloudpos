...
const NAV_ITEMS = [
  {
    ...
    label: "POS",
    icon: ShoppingBag,
    permission: FRONTEND_PERMISSIONS.BILLING_VIEW_OPEN,
  },
  {
    id: "menu",
    label: "Menu",
    icon: Utensils,
    permission: FRONTEND_PERMISSIONS.MENU_HIDE_SHOW_ITEMS,
  },
  {
    id: "staff",
    label: "Staff",
    icon: Users,
    permission: FRONTEND_PERMISSIONS.STAFF_VIEW,
  },
  {
    id: "inventory",
    label: "Inventory",
    icon: Package,
    permission: FRONTEND_PERMISSIONS.INVENTORY_VIEW_STOCK,
  },
  {
    id: "customers",
    label: "Customers",
    icon: User,
    permission: FRONTEND_PERMISSIONS.CUSTOMERS_VIEW_PROFILES,
  },
  {
    id: "reports",
    label: "Reports",
    icon: BarChart3,
    permission: FRONTEND_PERMISSIONS.REPORTS_VIEW,
  },
  {
    id: "settings",
    label: "Settings",
    icon: Settings,
    permission: FRONTEND_PERMISSIONS.SETTINGS_VIEW,
  },
] as const;
        ...
        <div className="fixed top-8 left-1/2 -translate-x-1/2 z-[100] animate-in fade-in slide-in-from-top-4 duration-300">
          <div className="bg-rose-500 text-white px-6 py-3 rounded-2xl shadow-2xl flex items-center gap-3 border border-rose-400">
            ...
            <span className="font-bold text-sm">
              Access not provided for {accessDeniedLabel}
            </span>
          </div>
        </div>
      )}
